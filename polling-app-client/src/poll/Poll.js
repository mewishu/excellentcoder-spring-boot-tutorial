...
class Poll extends Component {
    ...
    getTimeRemaining = (poll) => {
        const expirationTime = new Date(poll.gmtExpiration).getTime();
                    ...
                    <div className="poll-creator-info">
                        ...
                        <Link className="creator-link" to={`/users/${this.props.poll.createdBy.username}`}>
                            <Avatar className="poll-creator-avatar" 
                                style={{ backgroundColor: getAvatarColor(this.props.poll.createdBy.name), verticalAlign: 'middle' }}>
                            ...
                            <span className="poll-creation-date">
                                {formatDateTime(this.props.poll.gmtCreate)}
                            </span>
                        </Link>
                    </div>
